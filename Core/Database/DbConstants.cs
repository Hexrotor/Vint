...
public static class DbConstants {
    ...
    public const string PresetModules = "PresetModules";
    public const string Presets = "Presets";
    public const string PromoCodeItems = "PromoCodeItems";
    public const string PromoCodeRedemptions = "PromoCodeRedemptions";
    ...
    public const string WeaponSkins = "WeaponSkins";
    #endregion
